    ...
    let domString = `<form id="student-card">
                        ...
                        <div class="form-inline">
                            <div class="col-auto">
                                ...
                                <input type="text" class="form-control mb-2" onClick="this.form.reset()" onfocus="this.value=''" id="formInput" placeholder="Yer Name Here" required>
                            </div>
...
const buttonEvents = () => {
  ...
  // Calls the check for an empty form on button click.
